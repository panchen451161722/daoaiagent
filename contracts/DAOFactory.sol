...
contract DAOFactory {
    event DAOCreated(address indexed daoAddress, address creator, uint256 timestamp, bytes32 otherContentHash);
    ...
    function createDAO(address _tokenContractAddress, bool _allowIndependentAIA, bytes32 _otherContentHash) external {
        ...
        emit DAOCreated(address(newDao), msg.sender, block.timestamp, _otherContentHash);
    }
}
